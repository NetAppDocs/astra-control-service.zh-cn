...
确保集群运行状况良好且运行的是 Kubernetes 1.19 至 1.21.x 版，节点池已联机并运行的是 * Linux * 等。 <<Azure Kubernetes Service cluster requirements,了解有关此步骤的更多信息>>。
...
Kubernetes 版本:: 集群必须运行 Kubernetes 1.19 至 1.21.x 版
