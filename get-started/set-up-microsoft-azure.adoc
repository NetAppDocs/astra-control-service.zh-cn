...
如果您没有 Microsoft Azure 帐户，请先注册 Microsoft Azure 。然后，通过注册 NetApp 资源提供商来访问 Azure NetApp Files 。

.步骤
. 如果您已有 Microsoft Azure 帐户，请跳至步骤 4 。
...
注册后，在 Azure NetApp Files 中创建 NetApp 帐户。
