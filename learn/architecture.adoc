...
* * 存储后端 * ：
+
** Astra Control Service 使用 https://www.netapp.com/cloud-services/azure-netapp-files/["Azure NetApp Files"^]、Azure受管磁盘和 https://www.netapp.com/cloud-services/cloud-volumes-ontap/what-is-cloud-volumes/["NetApp Cloud Volumes ONTAP"] 作为AKS集群的存储后端。
** Astra Control Service 使用 https://www.netapp.com/cloud-services/cloud-volumes-service-for-google-cloud/["适用于 Google Cloud 的 NetApp Cloud Volumes Service"^]、Google Persistent Disk和 https://www.netapp.com/cloud-services/cloud-volumes-ontap/what-is-cloud-volumes/["NetApp Cloud Volumes ONTAP"] 作为GKE集群的存储后端。
** Astra Control Service 使用 https://docs.aws.amazon.com/ebs/["Amazon Elastic Block Store"^] 和 https://docs.aws.amazon.com/fsx/["适用于 NetApp ONTAP 的 Amazon FSX"^] 作为AWS集群的存储后端。
** Astra 控制中心使用以下存储后端：
+
