...
从 BitNami Helm 图表中了解如何部署 PostgreSQL 。在集群上部署 PostgreSQL 后，您可以向 Astra Control 注册此应用程序。

PostgreSQL 是一款经过验证的适用于 Astra 的应用程序。 link:../learn/validated-vs-standard.html["了解经过验证的应用程序与标准应用程序之间的区别"]。
