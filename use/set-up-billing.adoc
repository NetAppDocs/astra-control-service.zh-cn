...
* https://["查看 Cloud Volumes Service 的定价详细信息"^]。
+
请注意， Astra 控制服务支持所有服务类型和服务级别。您使用的服务类型取决于 https://["Google Cloud 地区"^]。

* https://["查看 Google Cloud 存储分段的定价详细信息"^]。
...
* https://["查看 Azure NetApp Files 的定价详细信息"^]。
* https://["查看 Microsoft Azure Blob 存储的定价详细信息"^]。
...
* https://["查看Amazon Web Services的定价详细信息"^]。
...
NOTE: 要观看Azure Marketplace订阅流程的视频演练、请访问 https://["NetApp TV"^]。

.步骤
. 转至 https://["Azure Marketplace"^]。
. 选择*立即获取*。
. 按照说明订阅计划。
