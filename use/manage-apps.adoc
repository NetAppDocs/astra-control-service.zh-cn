...
* 一组通过 Kubernetes 标签标识的资源（在 Astra Control 中称为 _custom app_ ）
+
...
*** 选择一个标签。
+
image:screenshot-select-label.gif["屏幕截图显示了单击标签数量后可从中选择的标签列表。"]
...
image:screenshot-system-apps.gif["屏幕截图显示了单击应用程序屏幕中的所有集群时可用的显示系统应用程序选项。"]
